...
<nav class="navbar navbar-expand-lg bg-primary">
    <div class="container-fluid">
        <a class="navbar-brand" aria-current="page" href="../index.php">Colegio Cristobal Colón</a>
...
<body style="background-color: #FFFDFB;">
    <div class="container-fluid" style="margin-top:16px">
        <div class="card">
            <h1 style="text-align: center;">¡Bienvenido, al sistema de control de estudiantes, docentes y personal administrativo! </h1>
        </div>
</body>
